...
#marka-find input:focus {
    border-color: #58a6ff;
}
#marka-find .marka-find-count {
    color: #8b949e;
    min-width: 60px;
    text-align: center;
}
...
#marka-find button:hover {
    background: #3d444d;
}
mark.marka-highlight {
    background: #58a6ff40;
    color: inherit;
    border-radius: 2px;
}
mark.marka-highlight.active {
    background: #f0883e;
    color: #1c2128;
}
@media (prefers-color-scheme: light) {
...
.marka-help-inner td:first-child {
    width: 120px;
    white-space: nowrap;
}
.marka-help-inner kbd {
    background: #2d333b;
    border: 1px solid #444c56;
    border-radius: 4px;
    padding: 1px 6px;
